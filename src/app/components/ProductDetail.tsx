		...
		<div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
			...
			<div className="lg:col-span-5">
				<div className="sticky top-24 space-y-4">
					...
					{/* thumbnail image jika input multiple file */}
				...
				<div className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-indigo-100/20 sticky top-24 space-y-6">
					...
					<div className="flex items-center gap-4">
						...
						<p className="text-sm text-gray-400">
							Stock:{" "}
							<span className="font-bold text-orange-500">{product.stock}</span>
						</p>
					</div>
					...
					<div className="space-y-3">
						...
						<button className="w-full bg-[#1F2937] text-white py-3 rounded-[1rem] font-bold flex items-center justify-center gap-2 hover:bg-black transition-all">
